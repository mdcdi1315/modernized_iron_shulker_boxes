    ...
    extends AbstractIronShulkerBoxMenu
{
    ...
    public NetheriteShulkerBoxMenu(int container_id, Inventory player_inventory) {
        super(IronShulkerBoxesMenuTypes.NETHERITE_SHULKER_BOX, container_id, player_inventory, IronShulkerBoxesTypes.NETHERITE);
    }
}
